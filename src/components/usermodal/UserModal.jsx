...
const UserModal = ({ modalVisible, setModalVisible, curAvailability, curDomain, curEmail, curFirstName, curGender, curLastName, setCurAvailability, setCurDomain, setCurEmail, setCurFirstName, setCurGender, setCurLastName, genders, availabilities, domains}) => {
  return (
    <Modal
        open={modalVisible}
